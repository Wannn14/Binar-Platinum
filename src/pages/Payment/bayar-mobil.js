...
import { Row, Col, Button, Form, Container, Card, ListGroup } from "react-bootstrap";
                    ...
                    <Col>
                        <Row>
                            <div className="col-lg-8">
                                <button className="p-3 fs-6 fw-bold btn-previous"><FaArrowLeft className="me-3 mb-1"/>Pembayaran</button>
                            </div>
                            <div className="col-lg-4 ">
                            <ul className="menu d-flex justify-content-center">
                                <img src={Step} className="mt-3"></img>
                    ...
                    <div className="col-lg-7">
                         <Card className="p-3">
                            ...
                            <ListGroup variant="flush border-bottom border-top-0 list-group-payment">
                                <ListGroup.Item>
                                    <Button  onClick={() => setChange (!change)} variant="outline-dark me-3 button-tf">BCA</Button>
                                    BCA Transfer
                                    {change ? <FaCheck className="float-check-right mt-2" /> : ""}
                                </ListGroup.Item>
                                <ListGroup.Item >
                                    <Button onClick={() => setChange1 (!change1)} variant="outline-dark me-3 button-tf">BNI</Button>
                                    BCA BNI
                                    {change1 ? <FaCheck className="float-check-right mt-2" /> : ""}
                                </ListGroup.Item>
                                <ListGroup.Item >
                                    <Button onClick={() => setChange2 (!change2)} variant="outline-dark me-3 button-tf">Mndiri</Button>
                                    BCA Mndiri
                                    {change2 ? <FaCheck className="float-check-right mt-2" /> : ""}
                                </ListGroup.Item>
                            </ListGroup>
                        </Card>
                     </div>
                    <div className="col-lg-5">
                        <Card className="p-3">
                            <Card.Body>
                                ...
                                <div className="total">
                                        <button onClick={() => setShow (!show)} className="btn-show" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                           <p>Total</p> { show ? <FaAngleUp className="mt-1 ms-2" /> : <FaAngleDown className="mt-1 ms-2" /> }
                                        </button>
